              ...
              >
                ...
                <div className="px-4 pb-4">
                  <div className="flex justify-between items-start mb-4">
                    <h3 className="text-2xl font-black text-gray-800 line-clamp-1 group-hover:text-[#422ad5] transition-colors">
                      {m.foodName}
                    </h3>
                  </div>
                  ...
                  <div className="flex items-center gap-3 mb-8">
                    <div className="h-10 w-10 rounded-full bg-gray-100 flex items-center justify-center border border-white shadow-sm overflow-hidden">
                      <img
                        src={m.chefImage || "https://i.ibb.co/5r5z0Lq/user.png"}
                        alt=""
                  ...
                  <Link
                    to={`/meals/${m._id}`}
                    className="flex items-center justify-center gap-2 w-full py-4 bg-gray-900 text-white font-bold rounded-2xl group-hover:bg-[#422ad5] transition-all duration-300 shadow-lg active:scale-95"
                  >
                    View Details
                    <ArrowRight size={18} />
                  </Link>
